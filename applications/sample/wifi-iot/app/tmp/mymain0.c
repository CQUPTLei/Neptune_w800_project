...
IotGpioValue max3012_interrupt(void)   
{
	//(void)arg;
	IotGpioValue val = {0};

    IoTGpioGetInputVal(PIN_INT, &val);
...
static void HeartrateDemo(void)
{
	...
	IoTGpioRegisterIsrFunc(IOT_GPIO_PB_00,IOT_INT_TYPE_EDGE,IOT_GPIO_EDGE_FALL_LEVEL_LOW, max3012_interrupt, NULL);  //中断使能，PB9,边缘触发、下降沿或低电平
 ...
 APP_FEATURE_INIT(HeartrateDemo);
