...
void max30102_init(void)
{
	...
	max30102_Bus_Write(REG_INTR_ENABLE_1,0xE0);	// INTR setting
	...
	max30102_Bus_Write(REG_LED1_PA,0x2f);   	//Choose value for ~ 7mA for LED1
	max30102_Bus_Write(REG_LED2_PA,0x2f);   	// Choose value for ~ 7mA for LED2
