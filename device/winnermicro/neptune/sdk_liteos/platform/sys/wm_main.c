...
int main(void)
{
    ...
    //tls_os_sem_create(&libc_sem, 1); //del 20201105
    ...
    TLS_DBGPRT_ERR("start task_start ...\n");
#if TLS_OS_FREERTOS
	tls_os_task_create(NULL, "User_Tsk",
					task_start,
					(void *)0,
					(void *)&TaskStartStk[0], 		   /* ����ջ����ʼ��ַ */
					TASK_START_STK_SIZE * sizeof(u32), /* ����ջ�Ĵ�С	   */
					1,
					0);
#elif TLS_OS_LITEOS
	tls_os_task_create(NULL, "User_Tsk",
     ...
     TLS_DBGPRT_ERR("start scheduler ...\n");               

	tls_os_start_scheduler();
    TLS_DBGPRT_ERR("os end\n");
