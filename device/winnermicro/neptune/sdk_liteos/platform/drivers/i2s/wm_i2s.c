...
void wm_i2s_init(I2S_InitDef *opts)
{
	//USE PB08 PB09 PB10 PB11 for i2s pin
	...
	I2S_InitDef opt = { I2S_MODE_MASTER, I2S_CTRL_STEREO, I2S_RIGHT_CHANNEL, I2S_Standard, I2S_DataFormat_16, 8000, 80000000};
	opt.I2S_AudioFreq = opts->I2S_AudioFreq * 1000;
	opt.I2S_DataFormat = (opts->I2S_DataFormat/8 - 1) << 4;

	wm_i2s_port_init(&opt);
