...
static void wm_bt_hfp_client_callback(tls_bthf_client_evt_t evt, tls_bthf_client_msg_t *msg)
{
	switch(evt)
	{
		case WM_BTHF_CLIENT_CONNECTION_STATE_EVT:
			hfp_client_connection_state_cb(msg->connection_state_msg.state, msg->connection_state_msg.peer_feat, msg->connection_state_msg.chld_feat, msg->connection_state_msg.bd_addr);
			break;
		...
		case WM_BTHF_CLIENT_CURRENT_CALLS_EVT:
			hfp_client_current_calls_cb(msg->current_calls_msg.index, msg->current_calls_msg.dir, msg->current_calls_msg.state, msg->current_calls_msg.mpty, msg->current_calls_msg.number);
			break;
